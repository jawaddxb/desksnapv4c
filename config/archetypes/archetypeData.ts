 ...
 *
 * Raw archetype configuration data - the single source of truth
 * for all archetype metadata including visual styles and colors.
 */

import type { ArchetypeDefinition } from './archetypeTypes';
